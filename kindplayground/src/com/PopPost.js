...
function PopPost() {
  ...
  useEffect(() => {
    fetcher(`${process.env.REACT_APP_BASE_URL}/api/community/get/top10?type=Normal&category=${category}`)
  }, [category])
        ...
        <div className="inner">
          <div className="mainpage_pop_head">
            <div className="mainpage_pop_head_inner">
              <p className="section-title">WEEKLY TOP TALK</p>
              ...
              <div className="mainpage_popList_left">
                {order1 ? 
                  Object.values(order1).map((value, index) => (
                    <a href={`/Community/${value.id}`} className="mainpage_popList_item">
