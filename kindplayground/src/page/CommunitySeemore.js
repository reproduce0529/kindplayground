...
function CommunitySeemore() {
  ...
  async function getPost() {
    ...
    if (res.data.post.category.type !== "Normal") {
      window.location.href = '/'
            ...
            <section className="ContentBox">
              <div className="inner">
                <div className="ReviewSeeMoreContentBox">
                  ...
                  <span className="Brackets">{data.post.category.category}</span>
                    <div className="ReviewSeeMoreContentBox_title">
                      {data.post.title}
                      <div>
                        <a href={`/CommunityForm/${id}`}>Edit </a>
              ...
              <div className="review_contentItem_bottom_item" onClick={reportSubmit}><i class="fa-regular fa-flag"></i></div>
                  ...
                  <div className="ReviewSeeMoreContentBox_Mainbox" dangerouslySetInnerHTML={{__html: xss(data.post.content)}}></div>
...
export default CommunitySeemore;
